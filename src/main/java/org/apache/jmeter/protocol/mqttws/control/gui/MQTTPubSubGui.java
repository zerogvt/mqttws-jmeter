...
import org.apache.jmeter.protocol.mqttws.sampler.PubSubSampler;
...
public class MQTTPubSubGui extends AbstractSamplerGui implements
		ChangeListener {
...
*/
	...
	private void setupSamplerProperties(PubSubSampler sampler) {
	...
	public void configure(TestElement el) {
		super.configure(el);
		PubSubSampler sampler = (PubSubSampler) el;
        ...
        isRetained.setSelected(sampler.getRetained());
	...
	public TestElement createTestElement() {
		PubSubSampler sampler = new PubSubSampler();
	...
	public String getLabelResource() {
		return "mqtt_publisher_subscriber"; //$NON-NLS-1$
	}

	@Override
	public void modifyTestElement(TestElement s) {
		PubSubSampler sampler = (PubSubSampler) s;
		setupSamplerProperties(sampler);
	}
